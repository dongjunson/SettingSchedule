      ...
      <div className="grid grid-cols-7 gap-0">
        {(() => {
          ...
          return getCalendarDays(currentMonth, showOutsideDays).map((day, i) => {
            ...
            const end = normalizeDate(endDate);
            const isSameDay =
              start && end && start.getTime() === end.getTime() && (isStart || isEnd);
            ...
            return (
              <div
                ...
                className={cn('flex items-center justify-center h-10', wrapperStyle)}
              >
                <button
                  type="button"
          ...
          <div className="flex items-center justify-center gap-3 text-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-blue-600">
                {props.tempStart
                  ? normalizeDate(props.tempStart)?.toLocaleDateString('ko-KR', {
                      month: 'short',
                      day: 'numeric',
                    }) || '-'
                  : startDate
                    ? normalizeDate(startDate)?.toLocaleDateString('ko-KR', {
                        month: 'short',
                        day: 'numeric',
                      }) || '-'
                    : '-'}
            ...
            <div className="flex items-center gap-2">
              ...
              >
                {props.tempStart && !endDate
                  ? '선택 중...'
                  : endDate
                    ? normalizeDate(endDate)?.toLocaleDateString('ko-KR', {
                        month: 'short',
                        day: 'numeric',
                      }) || '-'
                    : '-'}
