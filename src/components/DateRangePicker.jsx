...
export function DateRangePicker({ startDate, completionDate, onSelect, placeholder = "기간 선택", className }) {
  const [open, setOpen] = useState(false)
  const [month, setMonth] = useState(startDate ? new Date(startDate) : completionDate ? new Date(completionDate) : new Date())
